# **MAIA (Modular AI-driven Application) Project**
Welcome to MAIA\! This repository has been initialized to build a new software application using a state-of-the-art, AI-driven development process.
...
* **Specify Every Module:** Create a detailed blueprint (/upd) that tells the AI agents *exactly* what to build.
...
* The agents will read the blueprint and generate the application's source code into the /src directory.  

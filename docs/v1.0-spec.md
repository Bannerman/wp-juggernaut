...
- [ ] Fix `better-sqlite3` native module ABI conflict (see §7.2)
...
| `src/components/ResourceTable.tsx` | Column renders `resource-type` directly | ⚠️ Remains (columns not configurable) |
...
| `src/components/EditModal.tsx` | Basic/Classification/AI tabs | ⚠️ Remains (core tabs, lower priority) |
